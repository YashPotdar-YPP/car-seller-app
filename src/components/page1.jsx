...
export default function page1() {
    ...
    const [carCard] = useState({
        ...
        modelYear: [2021, 2019, 2020, 2020, 2021, 2019],
        seater: ["4 People", "4 People", "4 People", "4 People", "4 People", "4 People"],
        fuel: ["Hybrid", "Gasoline", "Gasoline", "Gasoline", "Gasoline", "Gasoline"],
        average: ["6.1km/1-litre", "8.2km/1-litre", "5.3km/1-litre", "7.7km/1-litre", "7.6km/1-litre", "7.2km/1-litre"],
        control: ["Automatic", "Automatic", "Automatic", "Automatic", "Automatic", "Automatic"],
        cost: ["$440", "$350", "$400", "$620", "$530", "$490"]
    });
                                ...
                                <nav className="mt-3 ms-5 ps-5">
                                    <ul className="pagination" style={{ color: "#4f5b72" }}>
                                        <li className="page-item">
                                            <Link
                                                className="page-link rounded border-0 shadow disabled"
                                                tabIndex="-1"
                                                style={textColor}
                                            >
                                                &larr;
